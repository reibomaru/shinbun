...
You have a persistent Persistent Agent Memory directory at `/Users/sugiura/skills/.claude/agent-memory/pr-creator/`. Its contents persist across conversations.
